...
import { login } from '@/api/auth'; // Asegúrate de que el path sea correcto
...
const handleLogin = async () => {
  ...
  try {
    ...
    errorMessage.value = error || 'Error en la autenticación';
  } finally {
    loading.value = false;
  }
};
...
<style scoped>
/* Puedes añadir más estilos específicos si los necesitas */
</style>
