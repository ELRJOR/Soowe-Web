<template>
    <section class="text-white mt-20" id="contact">
        <h2 class="text-4xl font-bold text-white text-left mb-4 px-4 xl:pl-16">Contacto</h2>
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Las grandes transformaciones comienzan con un paso. Si representas una organización y quieres sumarte a Soowe, completa los siguientes datos y nos pondremos en contacto contigo enseguida. ¡Únete al cambio ahora!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>www.linkedin.com/company/soowe</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                <div class="mb-6">
                    <label for="email" class="text-white block mb-2 text-sm font-medium">Correo Electrónico:</label>
                ...
                <div class="mb-6">
                    <label for="subject" class="text-white block mb-2 text-sm font-medium">Asunto:</label>
                ...
                <div class="mb-6">
                    <label for="message" class="text-white block mb-2 text-sm font-medium">Mensaje:</label>
                    <textarea id="Message" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="Cuentanos más ... " name="Message"></textarea>
                </div>
